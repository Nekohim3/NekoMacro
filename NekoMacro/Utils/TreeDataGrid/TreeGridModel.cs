...
{
    //public class TreeGridModel : ObservableCollectionWithMultiSelectedItem<TreeGridElement>
    //{
    ...
    //    {
    //        FlatModel.PrivateRemoveRange(FlatModel.IndexOf(child), 1);
    //    }
    ...
    //    private void OnRootRemoved(object item)
    //    {
    //        TreeGridElement root = TreeGridElement.VerifyItem(item);
    //        FlatModel.PrivateRemoveRange(FlatModel.IndexOf(root), 1);
    //    }

    //    private void CacheFlatChildren(TreeGridElement item)
    //    {
    //        // Iterate through all of the children within the item
    //        foreach (TreeGridElement child in item.Childs)
    //        {
    ...
    //        int children = item.Childs.Count;
    ...
    //        IList<TreeGridElement> items = ((parent != null) ? parent.Childs : this);
